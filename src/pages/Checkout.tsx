...
import { trackBeginCheckout, trackOrderSubmit } from '@/lib/analytics';
...
export default function Checkout() {
  ...
  // Track begin_checkout once on mount when cart has items
  useEffect(() => {
    if (items.length > 0) {
      trackBeginCheckout({ cart_items_count: items.length, cart_total: totalPrice });
    }
